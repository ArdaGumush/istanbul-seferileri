...
const HEIST_TARGETS = [
  {
    ...
    requiredRoles: ["asker_any", "asker_any"],
    equipmentOptions: [
      { id: "maske", name: "Maskeler", cost: 500, effect: "police_delay", effectValue: 1, description: "Polis dalgalarının ilk gelişini 1 tur geciktirir." },
      { id: "kesici", name: "Kasa Kesici", cost: 2000, effect: "vault_speed", effectValue: 1, description: "Kasa açma süresini 1 tur kısaltır." },
    ],
    baseSuccess: 55, payout: [80000, 180000],
  ...
  },
  {
    ...
    requiredRoles: ["asker_any", "asker_any", "asker_any"],
    equipmentOptions: [
      { id: "sinyal_kesici", name: "Sinyal Kesici", cost: 4000, effect: "police_delay", effectValue: 2, description: "Polis dalgalarının ilk gelişini 2 tur geciktirir." },
      { id: "agir_silah", name: "Ağır Silah Seti", cost: 6000, effect: "armor_pierce", effectValue: 0.15, description: "Ekibinin zırh delme oranını artırır." },
    ],
    baseSuccess: 40, payout: [250000, 600000],
  ...
  },
  {
    ...
    requiredRoles: ["asker_any", "asker_any", "surucu"],
    equipmentOptions: [
      { id: "patlayici", name: "Kapı Patlayıcısı", cost: 7000, effect: "vault_speed", effectValue: 2, description: "Kasa açma süresini 2 tur kısaltır." },
      { id: "takip_cihazi", name: "Takip Cihazı", cost: 3000, effect: "police_wave_size", effectValue: -1, description: "Gelen polis dalgalarının boyutunu azaltır." },
    ],
    baseSuccess: 35, payout: [400000, 900000],
  ...
  },
  {
    ...
    requiredRoles: ["asker_any", "asker_any", "surucu"],
    equipmentOptions: [
      { id: "sahte_kimlik", name: "Sahte Kimlikler", cost: 5000, effect: "police_delay", effectValue: 2, description: "Polis dalgalarının ilk gelişini 2 tur geciktirir." },
      { id: "lazer_kesici", name: "Lazer Kesici", cost: 12000, effect: "vault_speed", effectValue: 2, description: "Kasa açma süresini 2 tur kısaltır." },
    ],
    baseSuccess: 25, payout: [800000, 1600000],
...
if (typeof module !== "undefined") {
  module.exports = {
    ...
    HEIST_TARGETS, CREW_ROLES, COMBAT_CAPABLE_ROLES, FIRST_NAMES, LAST_NAMES, RIVAL_GANGS,
